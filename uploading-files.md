...
The framework has a utility class that can be used to handle file uploads using minimum amount of effort and code. The name of the class is [`Uploader`](https://webfiori.com/docs/WebFiori/Framework/Uploader) and its part of the namespace `WebFiori\Framework`.
