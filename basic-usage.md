...
class SayHi {
    public function __construct() {
        App::getResponse()->write('Hi Visitor. Welcome to my website!');
    }
}

```
The `WebFiori\Http\Response` class plays a crucial role in managing server responses. It primarily functions by accumulating output generated by application logic and sending it back to the client. The `App::getResponse()->write()` method is employed to append output to the response object. To delve deeper into the functionalities of this class, kindly refer to [this documentation](learn/class-response).
...
class SayHi {
    public function __construct() {
        ...
        App::getResponse()->write('Hi '.$personName.'. Welcome to my website!');
    }
}
